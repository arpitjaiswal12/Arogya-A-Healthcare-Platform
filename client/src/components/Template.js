...
const Template = ({ title, desc1, formtype, setIsLoggedIn }) => {
  return (
    <div className='flex items-center justify-center min-h-screen bg-white'>
      <div className='flex justify-between items-center w-full max-w-[1160px] gap-x-12 bg-white'>
        ...
        <div className='w-full max-w-[450px]'>
          ...
          {/* Optionally Google SignUp Button */}
        ...
        <div className='relative w-11/12 max-w-[450px]'>
          <img
            ...
            height={600}
            loading='lazy'
            className='w-full top-14 rounded-full'
          />
        </div>
