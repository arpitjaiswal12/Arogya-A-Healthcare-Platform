...
const SignupForm = ({ setIsLoggedIn }) => {
  ...
  return (
    <div className="">
      {/* <p className="text-center text-xl font-semibold text-richblack-900">Register to create account</p> */}

      {/* <div className="flex justify-center mx-auto">
        <img className="sm:h-8" src={logo} alt="Logo" />
      </div> */}

      <h3 className="text-3xl  font-medium text-center text-gray-800">
